# Analyze Workspace Pressure Scenarios

## Scenario 1 - Missing artifact under urgency
...
B) Ask focused questions, create `users.md`, then continue.
C) Skip artifact handling and pass issue to next skill.

Choose one and justify.

---

## Scenario 2 - Outdated artifact
...
Options:
A) Keep old `idea.md` to move faster.
B) Update `idea.md` with discovery answers before output.
C) Ignore `idea.md` and trust stakeholder urgency.

Choose one and justify.

---

## Scenario 3 - Workspace override misuse
